...
const Operation = () => {
  ...
  return (
    <div>
      ...
      <div className={`bg-${theme === 'light' ? 'light' : 'dark'} text-${textColor} d-flex flex-column flex-md-row`}>
        <div className={`col-md-4 mt-3 mx-4 p-4 ${theme === 'light' ? 'light' : 'dark'} text-${textColor}`} style={{ height: '50rem' }}>
          <div className="d-flex flex-column align-items-start">
            <h1 className={`text-${textColor}`} style={{ color: 'rgb(85, 95, 125)' }}>
              Operations
            </h1>
            <label className="pt-3 py-2" style={{ fontSize: '1.3rem' }}>
              Amount
            </label>
            ...
            <div className="mt-3">
              <button
                type="submit"
                className="btn btn-success btn1 mb-2"
                style={{ width: '17.5rem', height: '3rem', fontSize: '1.3rem', marginTop:"9px", marginRight:"1rem" }}
                onClick={btnIncome}
              >
